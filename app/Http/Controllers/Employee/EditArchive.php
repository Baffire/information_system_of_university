...
class EditArchive extends Controller
{
    use CheckRole;
        ...
        if ($this->checkRole()) {
            ...
            if ($request->has('name') && $request->has('description') && $request->has('software') && $request->has('teacher')) {
                ...
                $request->validate([
                    ...
                    'date_thesis_defense' => 'required_with_all:estimate,order_thesis_defense',
                ]);
                ...
                return redirect()->route('employee_archive');
            }
            ...
            return view('employee.editArchive', ['message' => $message, 'status' => $status, 'title' => $title, 'teachers' => $teachers]);
        } else {
            return redirect('/');
        }
    }
