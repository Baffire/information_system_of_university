...
class GetProgress extends Controller
{
    ...
    public function getProgress(Request $request)
    {
        if ($this->checkRole()) {
            ...
            return view('head.getProgress', ['all' => $all, 'students' => $students, 'roadmaps' => $roadmaps, 'training_program' => $training_program, 'year' => $year, 'degree' => $degree, 'message' => $message, 'status' => $status]);
