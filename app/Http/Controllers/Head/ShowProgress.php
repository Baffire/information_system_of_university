...
class ShowProgress extends Controller
{
    ...
    public function showProgress(Request $request)
    {
        if ($this->checkRole()) {
            ...
            $employee = Head::where('user_id', $user_id)->get();
            ...
            return view('head.showProgress', ['training_programs' => $training_programs, 'message' => $message, 'status' => $status]);
