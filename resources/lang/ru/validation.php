...
return [
	...
	*/
	...
	'attributes' => [
        ...
        'training_program'      => 'Образовательная программа',
        'group'                 => 'Группа',
		'city'                  => 'Город',
		'country'               => 'Страна',
		'address'               => 'Адрес',
        ...
        'finish_date'           => 'Дата окончания публикации',
        'file'                  => 'Файл',
        'year_of_admission'     => 'Год набора',
        'degree'                => 'Уровень подготовки',
        'estimate'              => 'Оценка на защите',
        'date_thesis_defense'   => 'Дата проведения защиты',
        'order_thesis_defense'  => 'Приказ о защите',
