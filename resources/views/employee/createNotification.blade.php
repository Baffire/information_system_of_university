                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group mt-4">
                        <div class="form-check">
                            <input name="teachers" class="form-check-input" type="checkbox" id="teachers" value="1">
                            <label class="form-check-label" for="teachers">
                                Видно преподавателям
                            </label>
                        </div>
                        <div class="form-check">
                            <input name="students" class="form-check-input" type="checkbox" id="students" value="1">
