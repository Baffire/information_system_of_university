    ...
    <div class="col-sm-12 col-md-9 col-lg-10">
        <div class="personal p-3 mt-3 border shadow">
            <p class="h5 text-center mt-4">
                Форма создания пункта контроля дорожной карты
            </p>
                ...
                <table class="table table-borderless mt-3 bg-white">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" id="name" placeholder="Введите наименование">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="finish_date" type="datetime-local" class="form-control" id="finish_date">
                        </div>
