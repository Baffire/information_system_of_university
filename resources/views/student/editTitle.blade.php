        ...
        <div class="personal p-3 mt-3 border shadow">
            ...
            <form action="" method="POST" class="mt-3">
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control" id="name" placeholder="Информационная система управления процессом организации ИГА в вузе" value="{{ $student_title->name }}">
                </div>
                <div class="form-group">
                    <label for="description">Описание</label>
                    <textarea name="description" class="form-control" id="description" rows="3">{{ $student_title->description }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="software" class="form-control" id="software" rows="3">{{ $student_title->software }}</textarea>
