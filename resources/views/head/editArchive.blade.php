        ...
        <div class="personal p-3 mt-3 border shadow">
            ...
            <form action="" method="POST" class="mt-3">
                ...
                <div class="form-group">
                    ...
                    <input name="date_thesis_defense" type="datetime-local" class="form-control" id="date_thesis_defense" value="{{ date('Y-m-d', strtotime($title->date_thesis_defense)) }}T{{ date('H:i', strtotime($title->date_thesis_defense)) }}">
                </div>
                <div class="form-group">
